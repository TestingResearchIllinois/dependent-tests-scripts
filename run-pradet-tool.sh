...
cp "$DT_DATA/$prioList/refinded-deps.csv" "$RESULTS_DIR/$prioList"
mkdir -p "$RESULTS_DIR/$seleList"
cp "$DT_DATA/$seleList/refinded-deps.csv" "$RESULTS_DIR/$seleList"
mkdir -p "$RESULTS_DIR/$paraList"
cp "$DT_DATA/$paraList/refinded-deps.csv" "$RESULTS_DIR/$paraList"
