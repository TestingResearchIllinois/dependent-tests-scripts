...
if [[ $1 == "" ]] || [[ $2 == "" ]] || [[ $3 == "" ]]; then
    ...
    echo "arg2 - The technique to run. Valid options are prio, sele, and para"
...
if [[ $TECH == "prio" ]] || [[ $TECH == "para" ]]; then
    bash $DT_SCRIPTS/setup-prio-para.sh
elif [[ $TECH == "sele" ]]; then
    bash $DT_SCRIPTS/setup-sele-firstVers.sh
    bash $DT_SCRIPTS/setup-sele-subseqVers.sh
else
