...
echo "*******************PRADET************************"
echo "Running pradet script"
date
/home/awshi2/dependent-tests-scripts/docker/run_pradet_tools.sh ${slug} ${module} ${oldcommit} ${newcommit} ${timeout}

echo "*******************PRADET************************"
echo "Finished run_project_pradet.sh"
date
