...
timeout ${timeout}s bash /home/awshi2/dependent-tests-scripts/precomputed-lifetime/run-precomputed-lifetime-new_commits.sh ${slug} ${module} ${oldcommit} ${newcommit} ${testtype} ${technique}
