...
cd /home/awshi2/dependent-tests-scripts/ && /home/awshi2/apache-maven/bin/mvn install:install-file -Dfile=impact-tools/dtdetector-1.2.0.jar -DgroupId=edu.washington.cs.dt -DartifactId=dtdetector -Dversion=1.2.0 -Dpackaging=jar
